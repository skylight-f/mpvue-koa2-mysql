...
<div class="goods"> 
  <div class="swiper">
    <swiper class="swiper-container" indicator-dot="true" autoplay="true" interval="3000" duration="1000">
...
data () {
 ...
 onShareAppMessage(){
   ...
   return {
     ...
     path: '/pages/goods/mian?id' + this.info.id,
